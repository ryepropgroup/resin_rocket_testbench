...
void get_pressures() {
  ...
  Serial.print(pressure_readings.p1);
  Serial.println();
  Serial.print(pressure_readings.p2);
  Serial.print(pressure_readings.p3);
}
...
void get_temperatures() {
  ...
  data_to_send.temp[0] = (MSB << 8) + LSB;
  data_to_send.sensor_flags = data_to_send.sensor_flags | (0b1 << 0);
  ...
  MSB = Wire.read();  //read the MSB of the temperature
  LSB = Wire.read();  //read the LSB of the temperature
  data_to_send.temp[1] = (MSB << 8) + LSB;
  data_to_send.sensor_flags = data_to_send.sensor_flags | (0b1 << 1);
}
...
void send_data() {
  ...
  Serial.print(converter.data.actuator_flags_1);
  Serial.print(" ");
  Serial.print(converter.data.actuator_flags_2);
  Serial.print(" ");
  Serial.println(converter.data.sensor_flags);
  Serial.print(converter.data.temp[0]);
  Serial.print(" ");
  Serial.println(converter.data.temp[1]);
  Serial.print(" ");
  //Serial.print(converter.data.pressure_readings.p1);
  Serial.print(" ");
  //Serial.print(converter.data.pressure_readings.p2);
  Serial.print(" ");
  //Serial.println(converter.data.pressure_readings.p3);
  Serial.print(" ");
  uint8_t actuator_flags_1;
  uint8_t actuator_flags_2;
  uint8_t sensor_flags;
